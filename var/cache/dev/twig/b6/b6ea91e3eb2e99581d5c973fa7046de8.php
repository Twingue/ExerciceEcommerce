...
<h1> Catégories </h1>
      ...
      <div>
       ...
       <div>
           <img src=\"/images/";
            // line 14
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categorie"], "image", [], "any", false, false, false, 14), "html", null, true);
            echo "\"> 
      </div>
      </a>
        ";
...
";
    ...
    {
        return array (  118 => 18,  108 => 14,  102 => 11,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<h1> Catégories </h1>
      ...
      <a href=\"/guitares_basses/{{ categorie.id }}\">
      <div>
            {{ categorie.nom }}
      </div>
       <div>
...
{% endblock %}
", "accueil/index.html.twig", "/home/twingue/Bureau/ExoECommerce-IdRecup/templates/accueil/index.html.twig");
    }
}
